    ...
    $("#UserRegistrationModal input[name='Email']").blur(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == true) {
                    PresentClosableBootstrapAlert("#alert_placeholder_register", "warning", "Invalid Email", "This email address has already been registerd.");
                    //var alertHtml = '<div class="alert alert-warning alert-dismissible fade show" role="alert">' +
                    //    '<strong>Invalid Email</strong><br>This email address has already been registerd.' +
